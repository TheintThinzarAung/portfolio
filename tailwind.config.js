  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-in-delay-longer': 'fadeIn 1s ease-in-out 0.6s forwards',
        'fade-in-delay-longest': 'fadeIn 1s ease-in-out 0.9s forwards',
        'width-expand': 'widthExpand 1s ease-in-out 1.2s forwards',
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { boxShadow: '0 0 15px rgba(192, 132, 252, 0.5)' },
          '50%': { boxShadow: '0 0 25px rgba(192, 132, 252, 0.8)' },
        },
      },
      backgroundImage: {
